...
---
## 写在最前面
这是一篇手动创建的教程，事实上你可以使用 Stackbit来自动创建我标题里面说的一切，并且更多选择，我会在另外一篇文章里，讲述如何做。其实手动创建除了有一点成就感外，还能够帮助你理解这些服务是如何组合到一起的，每一部分用来干什么的，以及每一个文件的用处，文章会有疏漏，欢迎留言一起反馈自己遇到的问题。
